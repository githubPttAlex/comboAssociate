...
<html>
    <head>
        ...
        <meta name="description" content="Documentation & Examples - comboAssociate - jQuery Plugin">
        <meta name="author" content="comboAssociate - jQuery Plugin">
        <title>Documentation & Examples - comboAssociate - jQuery Plugin</title>
        <!-- Bootstrap core CSS -->
        ...
        <main role="main">
          ...
          <section class="jumbotron text-center">
                <div class="container">
                  ...
                  <p class="lead text-muted">This plugin is useful when you need to manage single or multiple select HTML tags on your projects. 
                      See docs for more information.</p>
                </div>
          </section>
